...
buttons =document.querySelectorAll(".buttonSlide");

// console.log(slider,slide_image,images,buttons);
...
const slideImage = () => {
    ...
    picture.style.transform = `translate(-${imageIndex * 100}%)`;
...
buttons.forEach((buttonSlide) => buttonSlide.addEventListener("click", updateClick));
